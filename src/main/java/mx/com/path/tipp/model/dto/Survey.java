...
public class Survey {
    ...
    public Survey(Survey surveyOld) {
        this.name = surveyOld.getName();
        this.age = surveyOld.getAge();
        this.date = surveyOld.getDate();
        this.phone = surveyOld.getPhone();
        this.cellphone = surveyOld.getCellphone();
        this.status = surveyOld.getStatus();
        this.couple = surveyOld.getCouple();
        this.siblings = surveyOld.getSiblings();
        this.sons = surveyOld.getSons();
        this.answer1 = surveyOld.getAnswer1();
        this.answer2 = surveyOld.getAnswer2();
        this.answer3 = surveyOld.getAnswer3();
        this.answer4 = surveyOld.getAnswer4();
        this.sectionSensitives = cloneSection(surveyOld.getSectionSensitives());
        this.sectionCognitive = cloneSection(surveyOld.getSectionCognitive());
        this.sectionIntelligence = cloneSection(surveyOld.getSectionIntelligence());
        this.sectionContac = cloneSection(surveyOld.getSectionContac());
        this.sectionsProfile = cloneSection(surveyOld.getSectionsProfile());
        this.sectionsStrengths = cloneSection(surveyOld.getSectionsStrengths());
        this.sectionsTraits = cloneSection(surveyOld.getSectionsTraits());
    }

    public Survey() {
    }

    private List<Section> cloneSection(List<Section> sections) {

        List<Section> clone = new ArrayList<Section>();
